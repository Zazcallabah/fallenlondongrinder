...
#	"cascade,Progress,Casing...,5,PrepBaseborn"
	...
	"cascade,Basic,Shadowy,150,GrindShadowy"
#	"cascade,Progress,Casing...,13"
	"cascade,Stories,Tales of Mahogany Hall,10"
	"cascade,Elder,Presbyterate Passphrase,9"
	"cascade,Basic,Persuasive,150,GrindPersuasive"
	"cascade,Basic,Dangerous,150,GrindDangerous"
	"cascade,Basic,Watchful,150,GrindWatchful"
