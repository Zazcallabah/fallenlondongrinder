...
#	"cascade,Progress,Casing...,5,PrepBaseborn"
	...
	"cascade,Basic,Shadowy,120,GrindShadowy"
#	"cascade,Progress,Casing...,13"
	"cascade,Stories,Tales of Mahogany Hall,10"
	"cascade,Elder,Presbyterate Passphrase,9"
	"cascade,Basic,Persuasive,120,GrindPersuasive"
	"cascade,Basic,Dangerous,120,GrindDangerous"
	"cascade,Basic,Watchful,120,GrindWatchful"
